#ifndef PROMETHEUS_SLAM_MAP_COMM_MESH_CONVERTER_H_
#define PROMETHEUS_SLAM_MAP_COMM_MESH_CONVERTER_H_
 ...
 public:
  ...
  inline void setTrajectory(const nav_msgs::Path& path) {
    for (auto const& pose : path.poses) {
      prometheus_slam::TransformationD T_Sm_C;
...
#endif  //  PROMETHEUS_SLAM_MAP_COMM_MESH_CONVERTER_H_
