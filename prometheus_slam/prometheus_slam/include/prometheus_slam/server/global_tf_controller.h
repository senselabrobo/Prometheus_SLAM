#ifndef PROMETHEUS_SLAM_SERVER_GLOBAL_TF_CONTROLLER_H_
#define PROMETHEUS_SLAM_SERVER_GLOBAL_TF_CONTROLLER_H_
...
#include "prometheus_slam/server/client_tf_optimizer.h"
...
#endif  // PROMETHEUS_SLAM_SERVER_GLOBAL_TF_CONTROLLER_H_
