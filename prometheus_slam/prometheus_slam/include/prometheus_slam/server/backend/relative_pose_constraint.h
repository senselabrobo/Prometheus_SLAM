#ifndef PROMETHEUS_SLAM_SERVER_BACKEND_RELATIVE_POSE_CONSTRAINT_H_
#define PROMETHEUS_SLAM_SERVER_BACKEND_RELATIVE_POSE_CONSTRAINT_H_
...
#endif  // PROMETHEUS_SLAM_SERVER_BACKEND_RELATIVE_POSE_CONSTRAINT_H_
