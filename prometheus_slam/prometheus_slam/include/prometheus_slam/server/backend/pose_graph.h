#ifndef PROMETHEUS_SLAM_SERVER_BACKEND_POSE_GRAPH_H_
#define PROMETHEUS_SLAM_SERVER_BACKEND_POSE_GRAPH_H_
...
#include "prometheus_slam/server/backend/constraint_collection.h"
...
#endif  // PROMETHEUS_SLAM_SERVER_BACKEND_POSE_GRAPH_H_
