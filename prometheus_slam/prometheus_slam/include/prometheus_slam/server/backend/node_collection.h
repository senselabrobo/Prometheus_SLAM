#ifndef PROMETHEUS_SLAM_SERVER_BACKEND_NODE_COLLECTION_H_
#define PROMETHEUS_SLAM_SERVER_BACKEND_NODE_COLLECTION_H_
...
#endif  // PROMETHEUS_SLAM_SERVER_BACKEND_NODE_COLLECTION_H_
