#ifndef PROMETHEUS_SLAM_SERVER_CLIENT_HANDLER_H_
#define PROMETHEUS_SLAM_SERVER_CLIENT_HANDLER_H_
...
#include <prometheus_slam_msgs/MapTransform.h>
...
#include "prometheus_slam/utils/eval_data_publisher.h"
...
class ClientHandler {
 public:
  struct Config {
    Config()
        : client_name_prefix("prometheus_slam_client_"),
  ...
  inline void pubMapPoseTfMsg(
      const prometheus_slam_msgs::MapTransform& map_pose_update_msg) {
    ROS_ERROR("pubMapPoseTfMsg");
 ...
 private:
  void timeLineCallback(const prometheus_slam_msgs::TimeLine& time_line_msg);
...
#endif  // PROMETHEUS_SLAM_SERVER_CLIENT_HANDLER_H_
