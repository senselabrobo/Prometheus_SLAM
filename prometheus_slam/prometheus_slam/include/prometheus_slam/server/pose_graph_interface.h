#ifndef PROMETHEUS_SLAM_SERVER_POSE_GRAPH_INTERFACE_H_
#define PROMETHEUS_SLAM_SERVER_POSE_GRAPH_INTERFACE_H_
...
#endif  // PROMETHEUS_SLAM_SERVER_POSE_GRAPH_INTERFACE_H_
