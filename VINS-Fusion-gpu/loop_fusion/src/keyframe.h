...
public:
	...
	void computeWindowBRISKPoint(brisk::BriskDescriptorExtractor &_brisk_extractor);
  	void computeBRISKPoint(brisk::BriskDescriptorExtractor &_brisk_extractor);
	//void extractBrief();
	...
	// BRISK for pose graph backend
	vector<cv::KeyPoint> brisk_keypoints;
  	vector<cv::KeyPoint> brisk_keypoints_norm;
  	vector<cv::KeyPoint> brisk_window_keypoints;
	cv::Mat brisk_descriptors_;
  	cv::Mat brisk_window_descriptors_;
